...
definedAnimations.forEach {
    ...
    file.append("|delay|${info.delay}|${if (info.delay == ParamUsage.USED) info.delayDefault.toString() else ""}|\n")
    ...
    file.append("|spacing|${info.spacing}|${if (info.spacing == ParamUsage.USED) info.spacingDefault.toString() else ""}|\n")
