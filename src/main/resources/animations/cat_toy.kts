...
leds.apply {
    ...
    runSequential(
        ...
        section = getSection(0, pixel1, this.numLEDs)
    )
    ...
    runSequential(
        ...
        section = getSection(pixel2, pixel1, this.numLEDs)
    )
    ...
    runSequential(
        ...
        section = getSection(pixel2, pixel3, this.numLEDs)
    )
    ...
    runSequential(
        ...
        section = getSection(pixel4, pixel3, this.numLEDs)
    )
    ...
    runSequential(
        ...
        section = getSection(pixel4, pixel5, this.numLEDs)
    )
    ...
    runSequential(
        ...
        section = getSection(0, pixel5, this.numLEDs)
    )
}